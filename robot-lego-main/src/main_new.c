...
//int MOTOR_MAX = 80;
int speed3 = 0.8 * MOTOR_MAX;
int speed2 = 0.4 * MOTOR_MAX;
int speed1 = 0.2 * MOTOR_MAX;
...
int main(void)
{
    ...
    while (1)
    {
        ...
        {
        case 0b11011:
            diThang(MOTOR_MAX, MOTOR_MAX);
            break;
        case 0b11101:
            ReTrai(speed3, MOTOR_MAX);
            break;
        case 0b11110:
            ReTrai(speed2, MOTOR_MAX);
            break;
        case 0b11000:
            RePhai(MOTOR_MAX, speed1);
            break;
        case 0b10111:
            RePhai(MOTOR_MAX, speed3);
            break;
        case 0b01111:
            RePhai(MOTOR_MAX, speed2);
            break;
        case 0b00011:
            ReTrai(speed1, MOTOR_MAX);
            break;
        default:
            break;
        }
